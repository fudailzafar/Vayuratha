    ...
    <div>
      <div className="2xl:container mx-auto bg-white pb-1">
        ...
        <div className="w-[90%] md:w-[80%] mx-auto grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-6 mb-5 p-2 mt-5 gap-6 pb-6">
          ...
          <div className="hidden md:flex md:flex-col md:items-center md:text-center md:rounded-2xl md:border-2 md:border-gray-300 md:hover:cursor-pointer md:hover:shadow-2xl bg-slate-100 transition-all duration-500 ease-in-out hover:scale-105">
            <img
          ...
          <div className="hidden md:flex md:flex-col md:items-center md:text-center md:rounded-2xl md:border-2 md:border-gray-300 md:hover:cursor-pointer md:hover:shadow-2xl bg-slate-100 transition-all duration-500 ease-in-out hover:scale-105">
            <h1 className="text-gray-700 text-[20px] font-semibold font-[Montserrat] pt-16 transition-opacity duration-700 ease-in-out hover:opacity-90">
